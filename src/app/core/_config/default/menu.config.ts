	...
	public defaults: any = {
		...
		aside: {
			...
			items: [
				...
				{
					title: 'Booking', // <= Title of the page
					desc: 'Booking', // <= Description of the page
					root: true,
				...
				},
				{
					...
					desc: 'Reports', // <= Description of the page
					root: true,
					page: 'my-page', // <= URL
					icon: 'flaticon-line-graph', // <= Choose the icon
					bullet: 'dot',
				...
				{
					title: 'Activity Operations', // <= Title of the page
					desc: 'Some my description goes here', // <= Description of the page
					root: true,
					page: 'my-page', // <= URL
					icon: 'flaticon-line-graph', // <= Choose the icon
